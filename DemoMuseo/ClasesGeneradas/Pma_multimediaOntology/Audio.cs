...
namespace Pma_multimediaOntology
{
	...
	public class Audio : C1003_Manifestation
	{

		public Audio() : base() { } 

		public Audio(SemanticResourceModel pSemCmsModel, LanguageEnum idiomaUsuario) : base(pSemCmsModel,idiomaUsuario)
		{
		...
		public Audio(SemanticEntityModel pSemCmsModel, LanguageEnum idiomaUsuario) : base(pSemCmsModel,idiomaUsuario)
		{
		...
		public override string RdfType { get { return "http://museodelprado.es/ontologia/efrbrer.owl#Audio"; } }
		public override string RdfsLabel { get { return "http://museodelprado.es/ontologia/efrbrer.owl#Audio"; } }
		[LABEL(LanguageEnum.es,"http://museodelprado.es/ontologia/pradomuseum.owl#audioFile")]
		...
		public override List<string> ToOntologyGnossTriples(ResourceApi resourceAPI)
		{
			...
			AgregarTripleALista($"{resourceAPI.GraphsUrl}items/Audio_{ResourceID}_{ArticleID}", "http://www.w3.org/1999/02/22-rdf-syntax-ns#type", $"<http://museodelprado.es/ontologia/efrbrer.owl#Audio>", list, " . ");
			AgregarTripleALista($"{resourceAPI.GraphsUrl}items/Audio_{ResourceID}_{ArticleID}", "http://www.w3.org/2000/01/rdf-schema#label", $"\"http://museodelprado.es/ontologia/efrbrer.owl#Audio\"", list, " . ");
			AgregarTripleALista($"{resourceAPI.GraphsUrl}{ResourceID}", "http://gnoss/hasEntidad", $"<{resourceAPI.GraphsUrl}items/Audio_{ResourceID}_{ArticleID}>", list, " . ");
				if(this.Pm_audioFile != null)
				{
					AgregarTripleALista($"{resourceAPI.GraphsUrl}items/Audio_{ResourceID}_{ArticleID}",  "http://museodelprado.es/ontologia/pradomuseum.owl#audioFile", $"\"{GenerarTextoSinSaltoDeLinea(this.Pm_audioFile)}\"", list, " . ");
				}
				if(this.IdsPm_relatedArtWork != null)
				{
					foreach(var item2 in this.IdsPm_relatedArtWork)
					{
						AgregarTripleALista($"{resourceAPI.GraphsUrl}items/Audio_{ResourceID}_{ArticleID}", "http://museodelprado.es/ontologia/pradomuseum.owl#relatedArtWork", $"<{item2}>", list, " . ");
					}
				}
				if(this.Pm_publicationDate != null)
				{
					AgregarTripleALista($"{resourceAPI.GraphsUrl}items/Audio_{ResourceID}_{ArticleID}",  "http://museodelprado.es/ontologia/pradomuseum.owl#publicationDate", $"\"{this.Pm_publicationDate.Value.ToString("yyyyMMddHHmmss")}\"", list, " . ");
				}
				if(this.Efrbrer_p3020_has_title_of_the_manifestation != null)
				{
					AgregarTripleALista($"{resourceAPI.GraphsUrl}items/Audio_{ResourceID}_{ArticleID}",  "http://museodelprado.es/ontologia/efrbrer.owl#p3020_has_title_of_the_manifestation", $"\"{GenerarTextoSinSaltoDeLinea(this.Efrbrer_p3020_has_title_of_the_manifestation)}\"", list, " . ");
				}
			return list;
		}
		...
		public override List<string> ToSearchGraphTriples(ResourceApi resourceAPI)
		{
			...
			AgregarTripleALista($"http://gnoss/{ResourceID.ToString().ToUpper()}", "http://gnoss/type", $"\"http://museodelprado.es/ontologia/efrbrer.owl#Audio\"", list, " . ");
